...
import 'package:family/src/features/content/presentation/entertainment/craft/spring/flower_toiletpaperrolls.dart';
        ...
        content: [
          ...
          PrimaryButton(context, 'Blumen aus Klopapeirrollen', () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const FlowerToiletpaperrollsPage(),
              ),
            );
          }),
        ],
