...
import 'package:family/src/features/content/presentation/understanding/clean_table/clean_table_page3.dart';
import 'package:flutter/material.dart';

class CleanTablePage4 extends StatelessWidget {
  const CleanTablePage4({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const CleanTablePage3(),
                              ),
                            );
                          },
