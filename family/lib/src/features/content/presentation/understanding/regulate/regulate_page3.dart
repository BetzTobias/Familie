...
import 'package:family/src/features/content/presentation/understanding/regulate/regulate_page4.dart';
import 'package:flutter/material.dart';

class RegulatePage3 extends StatelessWidget {
  const RegulatePage3({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const RegulatePage4(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
