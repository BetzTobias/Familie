...
import 'package:family/src/features/content/presentation/understanding/regulate/regulate_page3.dart';
import 'package:flutter/material.dart';

class RegulatePage4 extends StatelessWidget {
  const RegulatePage4({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const RegulatePage3(),
                              ),
                            );
                          },
