...
import 'package:family/src/features/content/presentation/logical_thinking/logical_thinking_page3.dart';
import 'package:family/src/features/content/presentation/menu_page.dart';
import 'package:flutter/material.dart';

class LogicalThingkingPage2 extends StatelessWidget {
  const LogicalThingkingPage2({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const LogicalThingkingPage3(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
