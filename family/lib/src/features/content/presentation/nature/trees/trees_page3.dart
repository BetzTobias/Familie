...
import 'package:family/src/features/content/presentation/nature/trees/trees_page2.dart';
import 'package:family/src/features/content/presentation/nature/trees/trees_page4.dart';
import 'package:flutter/material.dart';

class TreesPage3 extends StatelessWidget {
  const TreesPage3({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const TreesPage2(),
                              ),
                            );
                          },
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const TreesPage4(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
