...
import 'package:family/src/features/content/presentation/nature/animals/animals_page5.dart';
import 'package:flutter/material.dart';

class AnimalsPage4 extends StatelessWidget {
  const AnimalsPage4({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const AnimalsPage5(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
