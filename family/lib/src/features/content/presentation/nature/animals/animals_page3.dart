...
import 'package:family/src/features/content/presentation/nature/animals/animals_page2.dart';
import 'package:family/src/features/content/presentation/nature/animals/animals_page4.dart';
import 'package:flutter/material.dart';

class AnimalsPage3 extends StatelessWidget {
  const AnimalsPage3({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const AnimalsPage2(),
                              ),
                            );
                          },
