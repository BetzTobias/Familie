                ...
                children: [
                  ...
                  buildMenuButton(context, 'Tiere', () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AnimalsPage(databaseRepository: databaseRepository,
                  ...
                  buildMenuButton(context, 'Bäume', () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TreesPage(databaseRepository: databaseRepository,
                          authRepository: authRepository,
                        ),
                      ),
                    );
                  ...
                  buildMenuButton(context, 'Blumen', () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => FlowersPage(databaseRepository: databaseRepository,
                          authRepository: authRepository,
                        ),
                      ),
                    );
