...
import 'package:family/src/features/content/presentation/nature/flowers/flowers_page2.dart';
import 'package:family/src/features/content/presentation/nature/flowers/flowers_page4.dart';
import 'package:flutter/material.dart';

class FlowersPage3 extends StatelessWidget {
  const FlowersPage3({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const FlowersPage2(),
                              ),
                            );
                          },
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const FlowersPage4(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
