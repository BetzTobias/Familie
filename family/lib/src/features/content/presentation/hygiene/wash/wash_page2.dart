...
import 'package:family/src/features/content/presentation/hygiene/wash/wash_page3.dart';
import 'package:family/src/features/content/presentation/menu_page.dart';
import 'package:flutter/material.dart';

class WashPage2 extends StatelessWidget {
  const WashPage2({super.key});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const WashPage3(),
                              ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
